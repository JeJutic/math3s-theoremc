...
\begin{theorem}[Дифференциал композиции (билет 1)]    % 20m
...
\begin{theorem}[Теорема Лагранжа для отображений (билет 2)]    % 1:15
...
\begin{theorem}[Достаточное условие дифференцируемости (билет 3)]    % 1:36
